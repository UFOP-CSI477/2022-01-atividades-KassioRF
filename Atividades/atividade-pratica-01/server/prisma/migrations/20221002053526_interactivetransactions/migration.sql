/*
  ...
  - You are about to drop the column `data` on the `doacoes` table. All the data in the column will be lost.
  - Added the required column `xdate` to the `doacoes` table without a default value. This is not possible if the table is not empty.
